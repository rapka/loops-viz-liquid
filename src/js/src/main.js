	...
	_addEventListner: function() {
		...
		listenButton.addEventListener("click", function() {
			...
			if (!playing && currentTrack != activeRelease) {
				...
				request.open('GET', 'tracks/knees.mp3', true);
...
if (desktop) {
	...
	var Clock = require('./engine/clock').Clock;
	var InputHandler = require('./engine/input').Handler;
	var debounce = require('./engine/utils').debounce;
	var ShaderManager = require('./engine/gl/shader').Manager;
	var geometry = require('./engine/gl/geometry');
	var FBO = require('./engine/gl/texture').FBO;
	var Mesh = require('./engine/gl/mesh').Mesh;
	var glcontext = require('./engine/gl/context');
	var glm = require('./gl-matrix');
	var ComputeKernel = require('./compute').Kernel;
	var vec2 = glm.vec2;
